...
public class UvsModel {
     ...
     * @return
     */
    public ArrayList<VisualizationMethod> getCorrecVisMethodsForUserInputs(String uncertaintyType, String dataFormat,
            String dataType, String domain) {
        ...
        ArrayList<VisualizationMethod> visList = getCorrecVisMethodsForUserInputs(uT, dF, dT, d);
    ...
    public ArrayList<VisualizationMethod> getCorrecVisMethodsForUserInputs(UncertaintyType uT, DataFormat dF,
            DataType dT, Domain d) {
        logger.debug(String.format(
                "New methods requested for uncertainty type = %s, data format = %s, data type = %s, domain = %s", uT,
                dF, dT, d));
        ...
        if (d != null) {
            // First branch
            if (uT instanceof AttributeUncertainty && dF instanceof RasterFormat && dT instanceof ContinuousType
                    && d instanceof MapVisualisationDomain) {
                VisualizationMethod contouringMethod = new Contouring(uT, dF, dT);
                visMethodsList.add(contouringMethod);
                StaticVisualizationMethod adjacentMapsMethod = new AdjacentMaps(uT, dF, dT);
                visMethodsList.add(adjacentMapsMethod);
                InteractiveVisualizationMethod statisticalDimensionInaGISMethod =
                        new StatisticalDimensionInAGIS(uT, dF, dT);
            ...
            // Second branch
            if (uT instanceof AttributeUncertainty && dF instanceof VectorFormat && dT instanceof ContinuousType
                    && d instanceof MapVisualisationDomain) {
                VisualizationMethod contouringMethod = new Contouring(uT, dF, dT);
                visMethodsList.add(contouringMethod);
                StaticVisualizationMethod adjacentMapsMethod = new AdjacentMaps(uT, dF, dT);
                ...
                InteractiveVisualizationMethod statisticalDimensionInaGISMethod =
                        new StatisticalDimensionInAGIS(uT, dF, dT);
                visMethodsList.add(statisticalDimensionInaGISMethod);
                InteractiveVisualizationMethod intervalsAndErrorBarsMethod = new IntervalsAndErrorbars(uT, dF, dT);
            ...
            // Third branch
            if (uT instanceof AttributeUncertainty && dF instanceof RasterFormat && dT instanceof CategoricalType
                    && d instanceof MapVisualisationDomain) {
                StaticVisualizationMethod adjacentMapsMethod = new AdjacentMaps(uT, dF, dT);
                visMethodsList.add(adjacentMapsMethod);
            }
            ...
            // Fourth branch
            if (uT instanceof AttributeUncertainty && dF instanceof VectorFormat && dT instanceof CategoricalType
                    && d instanceof MapVisualisationDomain) {
                StaticVisualizationMethod adjacentMapsMethod = new AdjacentMaps(uT, dF, dT);
                visMethodsList.add(adjacentMapsMethod);
            }
            ...
            // Fifth branch
            if (uT instanceof PositionalUncertainty && dF instanceof RasterFormat && dT instanceof ContinuousType
                    && d instanceof MapVisualisationDomain) {
                VisualizationMethod contouringMethod = new Contouring(uT, dF, dT);
                visMethodsList.add(contouringMethod);
            }
            ...
            // Sixth branch
            if (uT instanceof PositionalUncertainty && dF instanceof VectorFormat && dT instanceof ContinuousType
                    && d instanceof MapVisualisationDomain) {
                VisualizationMethod contouringMethod = new Contouring(uT, dF, dT);
                visMethodsList.add(contouringMethod);
            }
            ...
            // Seventh branch
            if (uT instanceof PositionalUncertainty && dF instanceof RasterFormat && dT instanceof CategoricalType
                    && d instanceof MapVisualisationDomain) {
                System.out.println("");
            }
            if (uT instanceof PositionalUncertainty && dF instanceof RasterFormat && dT instanceof CategoricalType
        ...
        // ///// without domain:
            ...
            if (uT instanceof AttributeUncertainty && dF instanceof RasterFormat && dT instanceof ContinuousType) {
                VisualizationMethod contouringMethod = new Contouring(uT, dF, dT);
                visMethodsList.add(contouringMethod);
                StaticVisualizationMethod exceedanceProbabilityMappingMethod =
                        new ExceedanceProbabilityMapping(uT, dF, dT);
                visMethodsList.add(exceedanceProbabilityMappingMethod);
                StaticVisualizationMethod rgbColourModelMethod = new RGBColourModel(uT, dF, dT);
                visMethodsList.add(rgbColourModelMethod);
                StaticVisualizationMethod whiteningMethod = new Whitening(uT, dF, dT);
                visMethodsList.add(whiteningMethod);
                StaticVisualizationMethod adjacentMapsMethod = new AdjacentMaps(uT, dF, dT);
                visMethodsList.add(adjacentMapsMethod);
                StaticVisualizationMethod symbolFocusMethod = new SymbolFocus(uT, dF, dT);
                visMethodsList.add(symbolFocusMethod);
                StaticVisualizationMethod opacityMethod = new Opacity(uT, dF, dT);
                visMethodsList.add(opacityMethod);
                DynamicVisualizationMethod animatedIsolinesMethod = new AnimatedIsolines(uT, dF, dT);
                visMethodsList.add(animatedIsolinesMethod);
                DynamicVisualizationMethod animationMethod = new Animation(uT, dF, dT);
                visMethodsList.add(animationMethod);
                InteractiveVisualizationMethod statisticalDimensionInaGISMethod =
                        new StatisticalDimensionInAGIS(uT, dF, dT);
                visMethodsList.add(statisticalDimensionInaGISMethod);
                DynamicVisualizationMethod blinkingPixelsMethod = new BlinkingPixels(uT, dF, dT);
                visMethodsList.add(blinkingPixelsMethod);
                DynamicVisualizationMethod blinkingRegionsMethod = new BlinkingRegions(uT, dF, dT);
            ...
            if (uT instanceof AttributeUncertainty && dF instanceof VectorFormat && dT instanceof ContinuousType) {
                ...
                VisualizationMethod contouringMethod = new Contouring(uT, dF, dT);
                visMethodsList.add(contouringMethod);
                StaticVisualizationMethod hierarchicalSpatialDataStructuresMethod =
                        new HierachicalSpatialDataStructures(uT, dF, dT);
            ...
            if (uT instanceof PositionalUncertainty && dF instanceof VectorFormat && dT instanceof CategoricalType) {
                DynamicVisualizationMethod animationMethod = new Animation(uT, dF, dT);
                visMethodsList.add(animationMethod);
        ...
        logger.info("Found {} elements: {}", visMethodsList.size(), Arrays.deepToString(visMethodsList.toArray()));

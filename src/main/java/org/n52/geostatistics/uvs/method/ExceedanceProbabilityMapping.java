...
public class ExceedanceProbabilityMapping extends StaticVisualizationMethod {
    ...
    private static String description =
            "Exceedance probability is used to depict the probability of exceeding a threshold in a certain pixel or area. This method is commonly used for environmental concentration maps where the exceedance of concentration thresholds are mapped <a href = 'http://www.sciencedirect.com/science?_ob=MiamiImageURL&_cid=271798&_user=2160112&_pii=S1352231006000100&_check=y&_origin=&_coverDate=31-May-2006&view=c&wchp=dGLzVlt-zSkWA&md5=4d0318ee5b8ddf38fe36734577ecdab1/1-s2.0-S1352231006000100-main.pdf'> (Van de Kassteele & Velders 2006) </a> <div id='scriptiny'><ul> <li onclick='TINY.box.show({iframe:'images/exceedance_probability.png/',boxid:'frameless',width:550,height:450,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function (){closeJS()}})'><img src='images/exceedance_probability.png' width = '50' height = '40'/> <em> Image taken from Van de Kassteele & Velders 2006 </em> </li> </ul></div>";

...
public class RGBColourModel extends StaticVisualizationMethod {
	...
	private static String description = "In a scenario where the uncertainty has to be generated for three variables, the colours red, green and blue are used to represent these variables whereas the amount of uncertainty is represented through the intensity of these colours, i.e. higher intensity indicates lower uncertainty. In instances where more than three variables are involved, the technique of colour mixing is incorporated. <a href = 'http://www.itc.nl/library/Papers/HENGL-pixel.pdf'>(Hengl et al. 2006)</a> <div id='scriptiny'><ul> <li onclick='TINY.box.show({iframe:'images/RGB colour model.png/',boxid:'frameless',width:550,height:450,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function (){closeJS()}})'><img src='images/RGB colour model.png' width = '40' height = '30'/><em>Images taken from MacEachren et al. 2005 and Hengl & Toomanian 2006</em></li> </ul></div> ";
